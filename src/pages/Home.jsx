    ...
    >
      {study.cardImage ? (
        <img
            ...
            className="case-card__img case-card__img--photo"
        />
        ) : (
        ...
        <div className="drawer__inner">
          ...
          {study.heroImage ? (
            <img
                ...
                className="cs-img-hero cs-img-hero--photo"
            />
            ) : (
